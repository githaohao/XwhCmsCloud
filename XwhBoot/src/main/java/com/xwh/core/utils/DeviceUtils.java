...
public class DeviceUtils {
    ...
    private static final String[] pcHeaders=new String[]{
    "Windows 98",
    "Windows ME",
    "Windows 2000",
    "Windows XP",
    ...
    private static final String[] mobileUserAgents=new String[]{
     ...
     * @Description: 根据当前请求的特征，判断该请求是否来自手机终端，主要检测特殊的头信息，以及user-Agent这个header
     * @param @param request  http请求
     * @param @return 如果命中手机特征规则，则返回对应的特征字符串
     * @return boolean
     * @throws
     */
